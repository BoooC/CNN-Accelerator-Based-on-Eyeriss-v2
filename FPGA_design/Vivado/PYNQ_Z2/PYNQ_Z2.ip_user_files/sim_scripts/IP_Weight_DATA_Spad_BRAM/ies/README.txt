...
#
# Generated by export_simulation on Tue Jan 09 20:44:57 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './IP_Weight_DATA_Spad_BRAM.sh' script.

./IP_Weight_DATA_Spad_BRAM.sh -reset_run
...
./IP_Weight_DATA_Spad_BRAM.sh -noclean_files

For more information on the script, please type './IP_Weight_DATA_Spad_BRAM.sh -help'.
