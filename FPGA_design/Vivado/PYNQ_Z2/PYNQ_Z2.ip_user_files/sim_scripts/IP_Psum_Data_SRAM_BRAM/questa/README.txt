...
#
# Generated by export_simulation on Tue Jan 09 20:43:31 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './IP_Psum_Data_SRAM_BRAM.sh' script.

./IP_Psum_Data_SRAM_BRAM.sh -reset_run
...
./IP_Psum_Data_SRAM_BRAM.sh -noclean_files

For more information on the script, please type './IP_Psum_Data_SRAM_BRAM.sh -help'.
