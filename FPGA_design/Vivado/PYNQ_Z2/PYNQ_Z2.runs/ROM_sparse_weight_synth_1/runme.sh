...
HD_PWD='C:/Users/p8101/Desktop/school/Univ/Special_project/LeNet_5_Eyeriss_v2/sim/PYNQ_Z2/PYNQ_Z2.runs/ROM_sparse_weight_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_sparse_weight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_sparse_weight.tcl
